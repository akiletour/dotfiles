# Generated by Powerlevel10k configuration wizard on 2021-10-16 at 15:40 CEST.
...
# dotted, darkest-ornaments, compact, concise, transient_prompt, instant_prompt=quiet.
...
() {
  ...
  # Custom icon.
   typeset -g POWERLEVEL9K_NODE_VERSION_VISUAL_IDENTIFIER_EXPANSION='NVM'
